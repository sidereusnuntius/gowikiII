...
func setupArticles(config config.WikiConfig, store articles.ArticleStore, tm *txdb.TxManager, search *search.Search, client client.Client) *articles.ArticleService {
	return articles.New(config, store, tm, search, client)
}
